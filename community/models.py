...
class Discussion(models.Model):
    ...
    """
    title = models.CharField(max_length=255, help_text="Title of the discussion.")
    ...
    created_at = models.DateTimeField(auto_now_add=True, help_text="Timestamp when the discussion was created.")
    updated_at = models.DateTimeField(auto_now=True, help_text="Timestamp when the discussion was last updated.")
    slug = models.SlugField(unique=True, blank=True, help_text="Slug for the discussion.")
